      ...
      {currentPage === 'home' ? (
        <>
          ...
          <section id="home" className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden">
            <h1 className="text-6xl font-heading text-white uppercase tracking-tighter mb-8">ALL STAR BATTLE 2026</h1>
        {/* Background elements */}
      ...
      <footer id="footer" className="bg-background-dark pt-24 pb-12 border-t border-primary/20 grainy-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 border border-white/10 flex items-center justify-center rounded-sm hover:bg-primary hover:text-background-dark transition-all duration-300" aria-label="Visiter notre site web">
                  <Globe className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 border border-white/10 flex items-center justify-center rounded-sm hover:bg-primary hover:text-background-dark transition-all duration-300" aria-label="Nous contacter par email">
                  <Mail className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 border border-white/10 flex items-center justify-center rounded-sm hover:bg-primary hover:text-background-dark transition-all duration-300" aria-label="Voir nos annonces">
          ...
          <div className="mt-10 flex flex-col md:flex-row gap-8 items-center border-t border-white/5 pt-8">
            ...
            <div className="flex gap-8">
              <a href="#" className="text-white hover:text-primary transition-all hover:scale-125" aria-label="Visiter Instagram"><Instagram className="w-5 h-5" /></a>
              <a href="#" className="text-white hover:text-primary transition-all hover:scale-125" aria-label="Visiter Facebook"><Facebook className="w-5 h-5" /></a>
              <a href="#" className="text-white hover:text-primary transition-all hover:scale-125" aria-label="Visiter Twitter"><Twitter className="w-5 h-5" /></a>
              <a href="#" className="text-white hover:text-primary transition-all hover:scale-125" aria-label="Visiter YouTube"><Youtube className="w-5 h-5" /></a>
            </div>
          </div>
